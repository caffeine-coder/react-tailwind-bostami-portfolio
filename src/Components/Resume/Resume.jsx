      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <div className="w-full flex flex-col lg:flex-row lg:items-start lg:p-2 lg:m-2">
          <div className="flex flex-col">
            ...
            <DetailCard
              classname="flex flex-col bg-rose-50 dark:bg-gray-700 w-[95%] self-center p-2 rounded-2xl mb-8 shadow-md"
              header="2022 Jun - Present"
              title="Associate Senior Software Engineer"
              description="Oracle Cerner"
            />
            <DetailCard
              classname="flex flex-col bg-sky-100 w-[95%] dark:bg-gray-700 self-center p-2 rounded-2xl mb-8 shadow-md"
              header="2020 Jun - 2022 Jun"
              title="Software Engineer"
              description="Cerner Corporation"
            />
            <DetailCard
              classname="flex flex-col bg-rose-50 w-[95%] dark:bg-gray-700 self-center p-2 rounded-2xl mb-8 shadow-md"
          ...
          <div className="flex flex-col">
            ...
            <div className=" flex justify-center items-center flex-col lg:ml-4">
              <DetailCard
                classname="flex flex-col bg-sky-100 dark:bg-gray-700 w-[95%] self-center p-2 rounded-2xl mb-8 shadow-md"
